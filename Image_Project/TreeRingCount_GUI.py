...
class TreeAgeApp:
    ...
    def segment_and_process_tree(self, image):
        ...
        remove_noise = self.remove_noise(segmented_image)
        remove_noise = self.remove_noise(remove_noise)
        ...
        local_equalized_image = self.apply_local_histogram_equalization(remove_noise)
        local_equalized_image = self.apply_local_histogram_equalization(local_equalized_image)
